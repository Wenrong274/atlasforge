...
def compress_file(filepath: Path) -> bool:
    ...
    original_text = read_text_utf8(filepath)
    ...
    write_text_utf8(backup_path, original_text)
    backup_readback = read_text_utf8(backup_path)
    if backup_readback != original_text:
        ...
        try:
            ...
            pass
        return False
    write_text_utf8(filepath, compressed)
    ...
    for attempt in range(MAX_RETRIES):
        ...
        if attempt == MAX_RETRIES - 1:
            ...
            write_text_utf8(filepath, original_text)
